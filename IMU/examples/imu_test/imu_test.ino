...
void loop()
{
  ...
  if (millis()-pre_time >= 50)
  {
    ...
    imu_msg.angular_velocity.x = imu.quat[0];
    imu_msg.angular_velocity.y = imu.quat[1];
    imu_msg.angular_velocity.z = imu.quat[2];
    ...
    imu_msg.linear_acceleration.x = imu.quat[3];
